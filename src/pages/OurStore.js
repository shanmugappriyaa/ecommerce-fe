...
<img src='images/gr3.svg' onClick={()=>{setGrid(6)}} className='d-block img-fluid' alt = 'grid' />
<img src='images/gr.svg' onClick={()=>{setGrid(12)}} className='d-block img-fluid' alt = 'grid' />                        </div>
                      </div>
                      </div>
                    </div>
